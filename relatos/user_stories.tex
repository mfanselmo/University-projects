...
\begin{document}
	...
	\begin{enumerate}
		...
		\item \story{usuario}{entrar a la página web con mi mail}{para poder recordar
		...
		\begin{enumerate}
			\item Guardar cantidad de suscriptores por foro
		\end{enumerate}
		...
		\begin{enumerate}
			\item Guardar reputación de usuarios
			
			\item Poder seleccionar al usuario
		\end{enumerate}
		...
		\item \story{usuario}{poder buscar suscribirme y desuscribirme facilmente a un foro}{estar pendiente de nuevas publicaciones en los temas que me gustan}
		\begin{enumerate}
			\item
		\end{enumerate}
		...
		\item \story{administrador}{poder acceder a un dashboard con estadisticas generales de la aplicacion}{saber como se estan realizando las sucripciones y creaciones de usuario}
		\begin{enumerate}
		...
		\item \story{administrador}{que cuando el comentario de un usuario sea eliminado disminuya su puntaje}{así poder \say{castigar} comentarios inapropiados}
		\begin{enumerate}
