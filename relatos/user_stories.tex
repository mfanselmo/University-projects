...
\begin{enumerate}
   ...
   \item \story{usuario}{poder votar en comentarios y publicaciones}{asi expresar lo que pienso de manera simple en publicaciones y comentarios.}
    ...
    \item \story{usuario}{poder buscar punlicaciones en un foro}
    ...
    \item \story{usuario}{poder buscar suscribirme y desuscribirme facilmente a un foro}{XXXXXXXXXXX}
    	\begin{enumerate}
			\item
		\end{enumerate}
	...
	\item \story{administrador}{poder acceder a un dashboard con estadisticas generales de la aplicacion}{XXXXX}
    	\begin{enumerate}
			\item
		\end{enumerate}
	...
	\item \story{???????}{que se asigne un puntaje por crear una publicación en un 	
		foro}{que así se pueda postular a \say{mejores cargos}}
		\begin{enumerate}
	...
	\item \story{???????????}{que cuando el comentario de un usuario sea eliminado disminuya su puntaje}{así poder \say{castigar} comentarios inapropiados}
		\begin{enumerate}
	...
	\item \story{??????????}{que el moderador tenga un puntaje}{así poder decidir quién puede ser administrador y quién no tras una postulación}
		\begin{enumerate}
			\item En otras palabrastambié, el moderador también es un usuario, por lo que también posee puntaje y debe postular para subir de \say{cargo}
		\end{enumerate}
